...
It has the following properties:
  ...
  adjustVolume: function (volume) { (Function) Function to console.log current volume
    if (volume >= 0 && volume <= 100) {
      this.currentVolume = volume;the adjustVolume("VALUE") value is when calling this function
