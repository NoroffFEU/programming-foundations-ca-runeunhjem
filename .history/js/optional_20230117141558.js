...
var youtubetest = document
youtubeButton.onclick = function () {
  resetButtonBackgroundColor();
  tv.tvIsOn = true;
  document.getElementById("tv__inside").innerHTML = "<iframe src="https://www.youtube.com/embed/mejqbQLLNz4"  width="967" height="544" title="BEST UPCOMING MOVIES 2023 (Trailers)" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>";
