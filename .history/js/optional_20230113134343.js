...
// ACTIVATE CORRECT COLOR ON BUTTON
tvButton.onclick = buttonColor => (source) {
  if (source === "PC') {
     document.getElementById("pc-button").style.backgroundColor = "green";
  } else if (source === 'tv') {
     document.getElementById("tv-button").style.backgroundColor = "red";
  } else {
