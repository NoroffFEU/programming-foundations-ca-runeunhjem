...
powerButton.onclick = function alternatePower() {
  ...
  if (tv.tvIsOn === true) {
    ...
    activeLogo.innerHTML =
      '<img src="images/input_icon.svg" alt="Active Logo">';
    tv__inside.style.backgroundColor = "darkgrey";
    tv__inside.innerHTML = "Choose your source?";
  }
};
...
function adjustVolume(volume) {
  if (!tv.tvIsOn) {
    // VOLUME should not work when TV is powered off
    console.log("Turn on the TV first");
    ...
    document.getElementById(
      "show-console-log"
    ).innerHTML = `Volume level is now set to ${volume}`;
    ...
    document.getElementById("show-console-log").innerHTML =
      "Volume level is out of range and invalid";
    setTimeout(function () {
      // SAME as arrow function in setTimeout over here
      document.getElementById("show-console-log").innerHTML = "";
    }, 5000);
  }
}
...
tvButton.onclick = function () {
  ...
  tv.tvIsOn = true;
  document
    .getElementById("tv__inside")
    .setAttribute(
      "style",
      "background-image: url(../images/tvbg/nrk-image.jpg);"
    );
  ...
  tv__inside.innerHTML = "";
  activeLogo.innerHTML =
    '<img src="images/nrk-logo-vector.svg" alt="Active Logo">';
...
pcButton.onclick = function () {
  ...
  document
    ...
    .setAttribute(
      "style",
      "background-image: url(../images/tvbg/pc-image.jpg);"
    );
...
ps5Button.onclick = function () {
  ...
  document
    ...
    .setAttribute(
      "style",
      "background-image: url(../images/tvbg/ps5-image.jpg);"
    );
...
chromecastButton.onclick = function () {
  ...
  document
    ...
    .setAttribute(
      "style",
      "background-image: url(../images/tvbg/chromecast-image.jpg);"
    );
...
netflixButton.onclick = function () {
  ...
  document
    ...
    .setAttribute(
      "style",
      "background-image: url(../images/tvbg/netflix-image.jpg);"
    );
...
disneyButton.onclick = function () {
  ...
  document
    ...
    .setAttribute(
      "style",
      "background-image: url(../images/tvbg/disney-image.jpg);"
    );
...
viaplayButton.onclick = function () {
  ...
  document
    ...
    .setAttribute(
      "style",
      "background-image: url(../images/tvbg/viaplay-image.jpg);"
    );
...
hboButton.onclick = function () {
  ...
  document
    ...
    .setAttribute(
      "style",
      "background-image: url(../images/tvbg/hbo-image.jpg);"
    );
...
discoveryButton.onclick = function () {
  ...
  document
    ...
    .setAttribute(
      "style",
      "background-image: url(../images/tvbg/discovery-image.jpg);"
    );
...
tv2Button.onclick = function () {
  ...
  document
    ...
    .setAttribute(
      "style",
      "background-image: url(../images/tvbg/tv2-image.jpg);"
    );
...
youtubeButton.onclick = function () {
  ...
  document
    ...
    .setAttribute(
      "style",
      "background-image: url(../images/tvbg/youtube-image.jpg);"
    );
...
spotifyButton.onclick = function () {
  ...
  document
    ...
    .setAttribute(
      "style",
      "background-image: url(../images/tvbg/spotify-image.jpg);"
    );
