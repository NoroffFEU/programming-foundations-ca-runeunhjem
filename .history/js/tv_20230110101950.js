...
// tv.adjustVolume(70); // adjust currentVolume to 70 (REMEMBER that adjustVolume is )
console.log("Doublecheck", tv.currentVolume); // Doublecheck currentVolume
tv.changeInput("pc"); // Does not exist due to lowerCaps
tv.changeInput("PC"); // Does exist