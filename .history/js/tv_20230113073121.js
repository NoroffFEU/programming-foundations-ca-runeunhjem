...
var tv = {
  ...
  power: function () {
    if(this.tvIsOn === true) {
      ...
      console.log("The TV is off - Turning it off");
      var tvIsOn = false;
      console.log(tvIsOn)
    }
    // console.log(this.tvIsOn);
  }
}; // **** End of tv object ****
...
powerButton.onclick = tv.power();
// powerButton.onclick = function alternatePower() {
//   if(this.tvIsOn === true) {
//     console.log("TV is on - Turning it of", this.tvIsOn);
//     tv__inside.innerHTML = "Turning of TV.";
//   }
// }
