...
/* tvButton.onclick = () =>{tvButton.style.backgroundColor="#CDCDCD";tvButton.style.color="#000";console.log("Before ===>",tv.activeTvSource);tv.activeTvSource="TV";console.log("After ===>",tv.activeTvSource);} */
